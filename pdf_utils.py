...
# every surface says the same thing: this tool is for educational and research
# use only, NOT for clinical decision-making without independent verification.
DISCLAIMER_TEXT = (
    "Disclaimer: This report is generated by an experimental tool for educational "
    "and research use only. It must NOT be used for clinical decision-making "
    "without independent verification. All growth parameters are derived from "
    "validated RCPCH reference data, but clinicians must exercise professional "
    "judgement and verify each value against the primary source. "
